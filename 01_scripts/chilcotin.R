...
#   - VCF file for Chilcotin region, MAF filtered
...
# User set variables
vcf.FN <- "02_input_data/chilcotin_w_tags_maf0.05_5w50kb.vcf.gz"
...
pop.vec <- gsub(pattern = "H$", replacement = "", x = pop.vec) # Remove remaining H character for the few inds from Chilko
