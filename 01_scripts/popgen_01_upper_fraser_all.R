...
# User set variables
vcf.FN <- "02_input_data/Oner.BiSNP.MM0.9.MAR0.01.MMD8-100.LCI.chr_retained_noindel5_miss0.15_SNP_q20_avgDP7_biallele_minDP7_maxDP10000_minGQ20_miss0.15_w_tags_MAF0.05_5w50kb.vcf.gz" # MAF and LD filtered
...
subset_to_variants <- 50000 # how many variants to limit the VCF file (debugging)
...
# Early Summer vs. Summer (No EStu)
...
pop.vec <- gsub("NadinaR", replacement = "Nadina", x = pop.vec)  # Remove everything from first underscore onwards
...
#### TODO FOR CHILCOTIN AND QUESNEL


#### TODO: need more colours below
...
if(file.exists(x = "00_archive/colours.csv")){
  ...
  unique_cols <- c("red", "darkgreen", "yellow", "blue", "orange", "purple", "cyan"
                   ...
                   , "red", "darkgreen", "yellow", "blue", "orange", "purple", "cyan"
                   , "magenta", "limegreen"
  )
